...
{
    [RoutePrefix("api/POS2Order")]
    public class POS2OrderController : ApiControllerBase
    {
        private IPOS2OrderService _orderService;

        public POS2OrderController(IPOS2OrderService orderService, IErrorService errorService) : base(errorService)
        {
