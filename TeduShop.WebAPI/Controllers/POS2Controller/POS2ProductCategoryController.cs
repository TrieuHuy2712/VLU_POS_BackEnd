...
{
    [RoutePrefix("api/POS2productCategory")]
    //[Authorize]
    public class POS2ProductCategoryController : ApiControllerBase
    {
        #region Initialize

        private IPOS2ProductCategoryService _productCategoryService;

        public POS2ProductCategoryController(IErrorService errorService, IPOS2ProductCategoryService productCategoryService)
            : base(errorService)
        {
