...
{
    [RoutePrefix("api/POS2product")]
    //[Authorize]
    public class POS2ProductController : ApiControllerBase
    {
        #region Initialize

        private IPOS2ProductService _productService;

        public POS2ProductController(IErrorService errorService, IPOS2ProductService productService)
            : base(errorService)
        {
