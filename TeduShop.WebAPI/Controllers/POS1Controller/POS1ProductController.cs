...
{
    [RoutePrefix("api/POS1product")]
    //[Authorize]
    public class POS1ProductController : ApiControllerBase
    {
        #region Initialize

        private IPOS1ProductService _productService;

        public POS1ProductController(IErrorService errorService, IPOS1ProductService productService)
            : base(errorService)
        {
