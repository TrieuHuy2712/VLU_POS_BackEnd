...
{
    [RoutePrefix("api/POS1productCategory")]
    //[Authorize]
    public class POS1ProductCategoryController : ApiControllerBase
    {
        #region Initialize

        private IPOS1ProductCategoryService _productCategoryService;

        public POS1ProductCategoryController(IErrorService errorService, IPOS1ProductCategoryService productCategoryService)
            : base(errorService)
        {
