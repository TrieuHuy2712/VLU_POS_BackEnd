...
namespace TeduShop.Web.Controllers.POS1Controller
{
    [RoutePrefix("api/POS1Order")]
    public class POS1OrderController : ApiControllerBase
    {
        private IPOS1OrderService _orderService;

        public POS1OrderController(IPOS1OrderService orderService, IErrorService errorService) : base(errorService)
        {
            ...
            string customerName, string paymentStatus, int page, int pageSize, string filter = null)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                List<OrderViewModel> modelVm = Mapper.Map<List<DetailOrder>, List<OrderViewModel>>(model);
       ...
       // [Permission(Action = "Read", Function = "ORDER")]
        ...
        public HttpResponseMessage Details(HttpRequestMessage request, int id)
        {
            ...
            {
                var orderVm = Mapper.Map<DetailOrder, OrderViewModel>(order);
        ...
        public HttpResponseMessage Update(HttpRequestMessage request, OrderViewModel orderVm)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                {
                    var dbOrder = _orderService.UpdateStatus(orderVm.ID);
                    ...
                    var responseData = Mapper.Map<DetailOrder, OrderViewModel>(dbOrder);
