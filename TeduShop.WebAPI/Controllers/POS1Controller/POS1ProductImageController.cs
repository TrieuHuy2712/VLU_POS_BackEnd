...
{
    [RoutePrefix("api/POS1productImage")]
    public class POS1ProductImageController : ApiControllerBase
    {
        private IPOS1ProductImageService _productImageService;

        public POS1ProductImageController(IPOS1ProductImageService productImageService, IErrorService errorService) : base(errorService)
        {
