...
{
    [RoutePrefix("api/OrderBackup")]
    public class OrderBackupController : ApiControllerBase
    {
        private IOrderBackupService _orderService;

        public OrderBackupController(IOrderBackupService orderService, IErrorService errorService) : base(errorService)
        {
            ...
            string customerName, string paymentStatus, int page, int pageSize, string filter = null)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                //List<OrderBackupViewModel> modelVm = Mapper.Map<List<OrderBackup>, List<OrderBackupViewModel>>(model);
                //PaginationSet<OrderBackupViewModel> pagedSet = new PaginationSet<OrderBackupViewModel>()
                //{
                //    PageIndex = page,
                //    PageSize = pageSize,
                //    TotalRows = totalRow,
        ...
        public HttpResponseMessage Details(HttpRequestMessage request, int id)
        {
            ...
            {
                var orderVm = Mapper.Map<OrderBackup, OrderViewModel>(order);
        ...
        public HttpResponseMessage GetOrderDetails(HttpRequestMessage request, int id)
        {
            ...
            {
                var detailVms = Mapper.Map<List<OrderBackupDetail>, List<OrderDetailViewModel>>(details);
        ...
        //                ExcelWorksheet sheet = package.Workbook.Worksheets["VLUOrder"];
