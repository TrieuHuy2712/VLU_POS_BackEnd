...
{
    public class BackupDbContext: IdentityDbContext<AppUser>
    {
        public BackupDbContext() : base("BackupConnection")
        {
            this.Configuration.LazyLoadingEnabled = false;
        }

        public DbSet<Footer> Footers { set; get; }
        public DbSet<OrderBackup> OrderBackups { set; get; }
        public DbSet<OrderBackupDetail> OrderBackupDetails { set; get; }
        ...
        public static BackupDbContext Create()
        {
