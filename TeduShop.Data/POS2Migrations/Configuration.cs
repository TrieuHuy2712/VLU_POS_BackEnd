namespace TeduShop.Data.POS2Migrations
{
    using Common;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TeduShop.Data.POS2DbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = true;
            MigrationsDirectory = @"POS2Migrations";
        }

        protected override void Seed(TeduShop.Data.POS2DbContext context)
        {
        ...
        private void CreateFunction(POS2DbContext context)
        {
        ...
        private void CreateConfigTitle(POS2DbContext context)
        {
        ...
        private void CreateUser(POS2DbContext context)
        {
        ...
        private void CreateProductCategorySample(TeduShop.Data.POS2DbContext context)
        {
        ...
        private void CreateFooter(POS2DbContext context)
        {
        ...
        private void CreateSlide(POS2DbContext context)
        {
        ...
        private void CreatePage(POS2DbContext context)
        {
        ...
        private void CreateContactDetail(POS2DbContext context)
        {
