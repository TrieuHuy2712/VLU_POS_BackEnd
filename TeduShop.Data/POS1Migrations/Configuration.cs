namespace TeduShop.Data.POS1Migrations
{
    using Common;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TeduShop.Data.POS1DbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = true;
            MigrationsDirectory = @"POS1Migrations";
        }

        protected override void Seed(TeduShop.Data.POS1DbContext context)
        {
        ...
        private void CreateFunction(POS1DbContext context)
        {
        ...
        private void CreateConfigTitle(POS1DbContext context)
        {
        ...
        private void CreateUser(POS1DbContext context)
        {
        ...
        private void CreateProductCategorySample(TeduShop.Data.POS1DbContext context)
        {
        ...
        private void CreateFooter(POS1DbContext context)
        {
        ...
        private void CreateSlide(POS1DbContext context)
        {
        ...
        private void CreatePage(POS1DbContext context)
        {
        ...
        private void CreateContactDetail(POS1DbContext context)
        {
