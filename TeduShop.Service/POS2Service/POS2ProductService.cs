...
{
    public interface IPOS2ProductService
    {
    ...
    public class POS2ProductService : IPOS2ProductService
    {
        private IPOS2ProductRepository _productRepository;
        private IPOS2TagRepository _tagRepository;
        private IPOS2ProductTagRepository _productTagRepository;
