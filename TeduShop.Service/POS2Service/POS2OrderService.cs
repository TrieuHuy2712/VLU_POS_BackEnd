...
{
    public interface IPOS2OrderService
    {
    ...
    public class POS2OrderService : IPOS2OrderService
    {
        private IPOS2OrderRepository _orderRepository;
        private IPOS2OrderDetailRepository _orderDetailRepository;
