...
{
    public interface IPOS1ProductService
    {
    ...
    public class POS1ProductService : IPOS1ProductService
    {
        private IPOS1ProductRepository _productRepository;
        private IPOS1TagRepository _tagRepository;
        private IPOS1ProductTagRepository _productTagRepository;
